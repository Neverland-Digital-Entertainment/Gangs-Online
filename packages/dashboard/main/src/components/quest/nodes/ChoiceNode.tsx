...
function ChoiceNode({ id, data }: NodeProps) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 border-2 border-purple-500 rounded-xl shadow-lg min-w-[280px]">
      ...
      <div className="p-3 space-y-2">
        {options.map((opt: any, idx: number) => (
          <div key={idx} className="border border-gray-200 dark:border-gray-700 rounded-lg p-2 relative">
            <button
